...
### Версия 0.2.0 - Базовая функциональность
...
- Базовое перетаскивание виджетов (без сохранения позиций)

### Версия 0.3.0 - Управление виджетами
- Полная функциональность Drag & Drop
- Изменение размеров виджетов
- Удаление виджетов
- Панель элементов управления виджетами при наведении
- Базовые настройки для каждого виджета
